...
namespace code2
{
    public partial class Code : Form
    {
        ...
        private void Code_Load(object sender, EventArgs e)
        {
            ...
            richTextBox1.TextChanged += this.OnTextChanged;
